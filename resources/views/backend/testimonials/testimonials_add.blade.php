...
<div class="col-lg-10">
	<div class="card">
		...
		<form id="myForm" method="post" action="{{ route('store.testimonials') }}" enctype="multipart/form-data" >
			@csrf
            ...
            <div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<input type="text" name="testi_title" class="form-control"   />
				</div>
			</div>

			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Testiomonial Text</h6>
				</div>
				<div class="form-group col-sm-9 text-secondary">
                    <textarea name="long_descp" id="" cols="30" rows="3" class="form-control"></textarea>
				</div>
			</div>
