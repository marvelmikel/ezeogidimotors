...
<!-- Page Title Here -->
<title>Ezeogidi Motors  - Login Your Credentials</title>
<!-- Mobile Specific -->
					...
					<div class="login-form ">
						<div class="tab-content bg-gray">
							<div id="login" class="tab-pane active text-center">
                                    <form method="POST" action="{{ route('login') }}" class="p-a30 dlab-form">
                                        @csrf
									...
									<div class="form-group">
										<input name="email" required="" class="form-control" id="email" placeholder="Email" type="email"/>
									</div>
									<div class="form-group">
										<input name="password" id="password" required="" class="form-control" placeholder="Type Password" type="password"/>
									</div>
									<div class="form-group text-left">
										<button class="site-button m-r5 inline-block">login</button>
										<div class="inline-block">
											<input id="check1" type="checkbox" class=""/>
											<label for="check1"> Remember me</label>
										</div>
										<a href="{{ route('password.request') }}" class="m-l5 inline-block"><i class="fa fa-unlock-alt"></i> Forgot Password</a> 
									</div>
									<div class="clearfix">
										<h5 class="form-title m-t5 pull-left">Sign In With</h5>
										<ul class="dlab-social-icon pull-right border dlab-social-icon-lg text-white">
							...
							<div class="bg-primary p-a15 bottom"> <a href="{{ route('register') }}" class="text-white">Create an account</a> </div>
							</div>
