	...
	<ul class="metismenu" id="menu">
		...
		<li>
			<a href="javascript:;" class="has-arrow">
				...
				<div class="menu-title">All Testimonials</div>
			</a>
			<ul>
				<li> <a href="{{ route('all.testimonials') }}"><i class="bx bx-right-arrow-alt"></i>All Testimonials</a>
				</li>
				<li> <a href="{{ route('add.testimonials') }}"><i class="bx bx-right-arrow-alt"></i>Add Testimonials</a>
				</li>
